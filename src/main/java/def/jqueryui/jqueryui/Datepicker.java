...
@jsweet.lang.Extends({DatepickerOptions.class})
public abstract class Datepicker extends Widget {
    public Regional regional;
    native public void setDefaults(DatepickerOptions defaults);
    native public String formatDate(String format, Date date, DatepickerFormatDateOptions settings);
    native public Date parseDate(String format, String date, DatepickerFormatDateOptions settings);
    native public double iso8601Week(Date date);
    native public Object[] noWeekends(Date date);
    /** This is an automatically generated object type (see the source definition). */
    @jsweet.lang.ObjectType
    public static class Regional extends def.js.Object {
        native public java.lang.Object $get(String languageCod3);
    }
    /**
    ...
    @jsweet.lang.Optional
    public Date endDate;
    native public String formatDate(String format, Date date);
    native public Date parseDate(String format, String date);
}
